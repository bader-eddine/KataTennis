...
namespace TestTennisNunit
{
    public class TestDataGenerator : IEnumerable<object[]>
    {
        private readonly List<object[]> _data = new List<object[]>
        {
            new object[] {0, 0, "Zero-All"},
            new object[] {1, 1, "Fifteen-All"},
            new object[] {2, 2, "Thirty-All"},
            new object[] {3, 3, "Deuce"},
            new object[] {4, 4, "Deuce"},
            new object[] {1, 0, "Fifteen-Zero"},
            new object[] {0, 1, "Zero-Fifteen"},
            new object[] {2, 0, "Thirty-Zero"},
            new object[] {0, 2, "Zero-Thirty"},
            new object[] {3, 0, "Forty-Zero"},
            new object[] {0, 3, "Zero-Forty"},
    ...
    public class TennisTests
    {
        ...
        private void CheckAllScores(ITennis game, int player1Score, int player2Score, string expectedScore)
        {
            ...
            Assert.Equals(expectedScore, game.GetScore());
        }
    }
}